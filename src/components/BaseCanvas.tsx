...
import { assignUniforms, loadShader, mapUniformSettingsToLocations } from '../../lib/gl/initialize';
...
const BaseCanvas = ({ fragmentShader, vertexShader, uniforms, setAttributes, setFragmentError, setVertexError }: Props) => {
