...
export const initFrameBufferObject = (
	gl: WebGLRenderingContext,
	textureWidth: number,
	textureHeight: number
): FBO => {
	...
	const targetTexture: WebGLTexture = createTargetTexture(
		gl,
		textureWidth,
		textureHeight,
		constants
	);
	const frameBuffer: WebGLFramebuffer = createFrameBuffer(
		gl,
		targetTexture,
		textureWidth,
		textureHeight,
